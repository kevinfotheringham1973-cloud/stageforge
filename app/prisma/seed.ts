...
async function main() {
  ...
  const boilerDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.common_detailed_scope_of_works", label: "Detailed Scope of Works", description: "Clear boundaries for what is and isn't included in the appointed contractor's price." },
      { key: "del.common_updated_cost_plan_contingency", label: "Updated cost plan including appropriate contingency", description: "A realistic budget envelope for the PFI Board / NHS lifecycle cost approval — a condition for the Pre-Contract Hold Point below." },
      { key: "del.boiler_water_treatment_strategy", section: "Technical Design Package", label: "Water treatment / chemical dosing / corrosion inhibitor strategy", description: "SHTM 04-01 Part A, BSRIA water treatment guidance." },
      { key: "del.boiler_bms_control_philosophy", section: "Technical Design Package", label: "BMS control philosophy, sequences & point schedules (new boilers + retained systems)", description: "SHTM 06-01." },
      { key: "del.boiler_electrical_design", section: "Technical Design Package", label: "Electrical design (boiler power, controls, temporary plant)", description: "SHTM 06-01." },
      { key: "del.boiler_flue_gas_oil_design", section: "Technical Design Package", label: "Flue system design, combustion air, gas & oil supply modifications" },
      { key: "del.boiler_structural_support_design", section: "Technical Design Package", label: "Structural / plinth / support design information" },
  ...
  const liftDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.lift_detailed_specifications", section: "Technical Design Package", label: "Detailed specifications (drive system, controller, doors, safety gear, finishes, communication systems)", description: "SHTM 08-02, BS EN 81 series." },
      { key: "del.common_updated_cost_plan_contingency", label: "Updated cost plan including appropriate contingency", description: "A realistic budget envelope for the PFI Board / NHS lifecycle cost approval — a condition for the Pre-Contract Hold Point below." },
  ...
  const bmsDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.bms_cybersecurity_design", section: "Technical Design Package", label: "Cybersecurity design and resilience measures", description: "Current NHS / national cyber resilience guidance." },
