...
async function main() {
  ...
  const waterDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.water_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const boilerDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.boiler_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const ventilationDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.ventilation_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const medicalGasesDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.medgas_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const chilledWaterDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.chilledwater_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const steamDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.steam_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const fireSuppressionDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.firesuppression_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  const ptsDeliverableDefsByStage: DeliverableDef[][] = [
    ...
    [
      ...
      { key: "del.pts_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  await createDeliverableTemplates(roomOrWardRefreshStageTemplates, [
    ...
    [
      ...
      { key: "del.wardrefresh_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  await createDeliverableTemplates(mhuLigatureStageTemplates, [
    ...
    [
      ...
      { key: "del.mhu_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
  ...
  await createDeliverableTemplates(theatreRefreshStageTemplates, [
    ...
    [
      ...
      { key: "del.theatrerefresh_ppm_documentation", label: "Provide valid PPM (Planned Preventative Maintenance) documentation for the existing plant being replaced", description: "Maintenance history and current compliance status of the asset being replaced, submitted alongside the quotations for PFI Board / NHS lifecycle approval." },
